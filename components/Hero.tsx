        ...
        <section>
            <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                <div className="mr-auto place-self-center lg:col-span-7">
                    ...
                    {contact && (
                        <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg transition-all duration-300 ease-in-out dark:bg-blue-900/20 dark:border-blue-800">
