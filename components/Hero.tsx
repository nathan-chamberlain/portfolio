        ...
        <section>
            <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:items-start">
                <div className="mr-auto place-self-center lg:col-span-7">
                    ...
                    <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Hi! I am a full stack software engineer. I currently work at Datacom as a Graduate Developer in the App Assurance AI Team. I enjoy learning about and using the most cutting edge technology.</p>
