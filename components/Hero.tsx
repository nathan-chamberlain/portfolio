        ...
        <section>
            <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:items-start">
                <div className="mr-auto place-self-center lg:col-span-7">
                    ...
                    <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Hi! I am an aspiring full stack software engineer. I work part time as the Digital Support Coordinator at Gemtech, an NZ-owned Wellington consultancy. I am currently developing a new website for Gemtech using Next.js. I am undertaking a research project with Te Whatu Ora to develop Sepsis App (SAPP), a tablet application that will support decision making around sepsis in emergency departments. I am in my honours year of a software engineering degree at Victoria University, where I also tutor 3rd year Engineering Project Management, and Applied Cryptography.</p>
