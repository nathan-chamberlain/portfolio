...
export default function Sapp() {
    const [sappOpen, setSappOpen] = useState<boolean>(false);
    const iframeRef = useRef<HTMLDivElement>(null);

    useEffect(() => {
        if (sappOpen && iframeRef.current) {
            // Scroll to iframe after a short delay to allow for rendering
            setTimeout(() => {
        ...
        <>
            <section>
                <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    <div className="max-w-screen-md mb-16 lg:mb-24">
                        <article className="w-full format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
                            <header className="mb-4 lg:mb-6 not-format">
                                <h1 className="mb-4 text-3xl font-extrabold leading-tight text-gray-900 lg:mb-6 lg:text-4xl dark:text-white">Sepsis App (SAPP)</h1>
                            </header>
                            <p className="lead">SAPP is an application that supports clinical decision-making around patients who may have sepsis or an infection.
                                It is designed to be used in the emergency department.</p>
                            <p>
                                I am currently developoing SAPP in collaboration with Victoria University, CCDHB, Te Whatu Ora, and Wellington Hospital.
                            </p>
                            <p>
                                Clinicians in the Wellington Hospital emergency department are time-poor, with triaging taking on average ten minutes or less.
                                SAPP addresses this through its efficient and simplistic design, allowing clinicians to quickly assess patients and make informed decisions about their care.
                            </p>
                            <p>
                                The application is designed to be used on a tablet, with a user-friendly interface that allows clinicians to quickly input patient information and receive recommendations for further action.
                                SAPP is currently in development, with plans for user testing and trials in the near future.
                            </p>
                            <p>
                    ...
                    <h2 className="mb-8 text-2xl font-bold leading-tight text-gray-900 lg:mb-12 lg:text-3xl dark:text-white">Tech stack</h2>
                    <div className="space-y-8 grid grid-cols-2 md:grid-cols-3 gap-12">
                        <div>
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Expo</h3>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full lg:h-12 lg:w-12">
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">React Native</h3>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full lg:h-12 lg:w-12">
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Tailwind</h3>
                        </div>
            ...
            {sappOpen && (
                <div
                    ref={iframeRef}
                    className="hidden md:flex h-full w-full flex-col items-center justify-center py-8 opacity-0 animate-fadeIn"
                >
                    <div className="w-full max-w-7xl aspect-video">
                        <iframe
                            src="https://sepsis-app.netlify.app/"
