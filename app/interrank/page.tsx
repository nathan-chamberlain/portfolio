...
import SupabaseLogo from "@/public/images/supabase.svg"
import ProjectHero from "@/components/ProjectHero"

import interrank1 from "@/public/images/interrank1.png"
import interrank2 from "@/public/images/interrank2.png"
    ...
    return (
        <>
            <ProjectHero
                ...
                images={images}
                url="https://interrank.xyz"
            />
            <ProjectContent
                title="About interrank.xyz"
                sections={[
            ...
            <TechStack>
                ...
                <TechItem
                    name="Supabase"
                    icon={<ExportedImage src={SupabaseLogo} alt="Supabase Logo" width={32} height={32} />}
                />
            </TechStack>
        </>
